...
const TravelGuideAdd = () => {
  ...
  const handleAutocompleteChange = (dayIndex, destinationIndex, newValue) => {
    const newItinerary = [...itinerary];
    newItinerary[dayIndex].destinations[destinationIndex].location_id = newValue.value;
    newItinerary[dayIndex].destinations[destinationIndex].name = newValue.label;
    setItinerary(newItinerary);
  };

  const handleDestinationChange = (dayIndex, destinationIndex, field, value) => {
    const newItinerary = [...itinerary];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formData.append("FeatureDestination", JSON.stringify(featureDestinationObject));
      ...
      const response = await axios.post(
        `${process.env.REACT_APP_API_URL}/tg/upload`,
        formData,
        {
          headers: {
      ...
      console.error("Error uploading travel guide:", error.response?.data?.message);
    }
  };
